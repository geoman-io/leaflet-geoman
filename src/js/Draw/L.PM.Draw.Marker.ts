...
export interface IDrawMarker {
  ...
  _handleSnapping?: (e: MapMouseEvent) => void;
...
const DrawMarker = (
  ...
  _syncHintMarker(this: IDrawMarker, e: L.LeafletMouseEvent) {
    ...
    if (this.options.snappable) {
      const fakeDragEvent = e as MapMouseEvent;
...
(Draw as unknown as { Marker: unknown }).Marker = DrawMarker;
