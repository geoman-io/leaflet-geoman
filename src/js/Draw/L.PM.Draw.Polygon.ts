...
import DrawLine from './L.PM.Draw.Line';
...
const DrawPolygon = (
  DrawLine as unknown as { extend: (props: object) => unknown }
).extend({
  ...
  _createMarker(this: IDrawPolygon, latlng: L.LatLng) {
    ...
    }) as L.Marker & { _pmTempLayer?: boolean };
...
(Draw as unknown as { Polygon: unknown }).Polygon = DrawPolygon;
