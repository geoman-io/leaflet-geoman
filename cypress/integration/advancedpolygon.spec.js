describe('Draw & Edit Poly', () => {
  ...
  it('drawAdvancedPolygon', () => {
    cy.window().then(({ map, L }) => {
      map.setView([18.52, 73.85], 9);
      L.advancedPolygon([[18.7,72.1],[19,74],[18.52,73.85],[18.7,72.1]]).addTo(map);
    });
  });
  // it('drages shared vertices when pinned', () => {
  //   cy.toolbarButton('AdvancedPolygon').click();
  //
  //   cy.get(mapSelector)
  //     .click(120, 150)
  //     .click(120, 100)
